// ================================================================
// config/movements.js — workout movement ontology
// ================================================================
...
// 약점 subPattern을 보강하는 종목을 제안한다. 이때 바벨/덤벨 종목에
// +가중치를 주어 우선 노출. 강제는 아님 — 머신/케이블/스미스도 후보.
// ════════════════════════════════════════════════════════════════
export const MAX_PREFERRED_CATEGORIES = ['barbell', 'dumbbell'];
