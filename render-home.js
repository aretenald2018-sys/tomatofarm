...
import { TODAY, getMuscles, getCF, getDiet, dietDayOk,
         ...
         shouldShow, isAdmin, isAdminGuest, getAdminId, getAdminGuestId, isSameInstance, isAdminInstance, getDataOwnerId,
...
window.openFriendProfile = async function(friendId, friendName, scrollToSection) {
  ...
  // SSOT: admin 계정 ID 정규화 (guest → admin으로 통일)
  ...
  // admin 계정의 nickname은 admin/guest 양쪽에서 가장 유효한 값 찾기
